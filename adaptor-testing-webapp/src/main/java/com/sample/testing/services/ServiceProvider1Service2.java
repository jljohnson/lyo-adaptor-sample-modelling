...
@Path("serviceProviders1/{serviceProviderId}/service2/resources")
@Api(value = "OSLC Service for {" + Oslc_rmDomainConstants.REQUIREMENT_LOCALNAME + ", " + Oslc_qmDomainConstants.TESTSCRIPT_LOCALNAME + "}")
public class ServiceProvider1Service2
{
    ...
    public ServiceProvider1Service2()
    {
        super();
    }
    ...
    public Requirement[] queryRequirementsForQueryCapability1(
                                                    ...
                                                    @QueryParam("limit") final String limitString) throws IOException, ServletException
    {
        ...
        final List<Requirement> resources = TestingToolManager.queryRequirementsForQueryCapability1(httpServletRequest, serviceProviderId, where, page, limit);
    ...
    public Response queryRequirementsAsHtmlForQueryCapability1(
                                    @PathParam("serviceProviderId") final String serviceProviderId ,
                                       @QueryParam("oslc.where") final String where,
                                       @QueryParam("page") final String pageString,
                                    @QueryParam("limit") final String limitString) throws ServletException, IOException
    {
        ...
        // Start of user code queryRequirementsAsHtmlForQueryCapability1
        // End of user code
        ...
        if (resources!= null) {
            ...
            // Start of user code queryRequirementsAsHtmlForQueryCapability1_setAttributes
            // End of user code
    ...
    public Response createTestScriptForCreationFactory1(
            @PathParam("serviceProviderId") final String serviceProviderId ,
            final TestScript aResource
        ) throws IOException, ServletException
    {
        try {
            TestScript newResource = TestingToolManager.createTestScriptForCreationFactory1(httpServletRequest, aResource, serviceProviderId);
        ...
        ) throws IOException, ServletException, URISyntaxException
    {
        ...
        final Requirement aRequirement = TestingToolManager.getRequirement(httpServletRequest, serviceProviderId, requirementId);
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aRequirement != null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/com/sample/testing/requirement.jsp");
            rd.forward(httpServletRequest,httpServletResponse);
        }
    ...
    @GET
    @Path("requirements/{requirementId}/smallPreview")
    @Produces({ MediaType.TEXT_HTML })
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aRequirement != null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/com/sample/testing/requirementsmallpreview.jsp");
            httpServletResponse.addHeader(TestingToolConstants.HDR_OSLC_VERSION, TestingToolConstants.OSLC_VERSION_V2);
            rd.forward(httpServletRequest, httpServletResponse);
        }
    ...
    @GET
    @Path("requirements/{requirementId}/largePreview")
    @Produces({ MediaType.TEXT_HTML })
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aRequirement != null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/com/sample/testing/requirementlargepreview.jsp");
            httpServletResponse.addHeader(TestingToolConstants.HDR_OSLC_VERSION, TestingToolConstants.OSLC_VERSION_V2);
            rd.forward(httpServletRequest, httpServletResponse);
        }
